...
pub fn main(init: std.process.Init) !void {
    ...
    try stdout.print(
        ...
        \\  darwin-actiond serve-vm [--kernel=/path/Image[.zst]] [--initramfs=/path/initramfs.cpio[.zst]] [--runtime-image=/path/runtimes.sqfs] [--actiondfs-fstype=actiondfs|actiondfs_vec|actiondfs_bucket] [--listen=127.0.0.1:8980] [--root=/tmp/actiond-vm]
        \\
    , .{
        actiond.version.zig,
