...
pub fn main(init: std.process.Init) !void {
    ...
    try stdout.print(
        ...
        \\  darwin-actiond serve-vm [--kernel=/path/Image] [--initramfs=/path/initramfs.cpio.zst] [--runtime-image=/path/runtimes.sqfs] [--listen=127.0.0.1:8980] [--root=/tmp/actiond-vm]
        \\
    , .{
        actiond.version.zig,
