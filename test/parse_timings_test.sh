...
cat >"${log}" <<'EOF'
info: execute timing aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/123: total_ns=10000000 input_fetch_ns=2000000 execution_ns=7000000 output_upload_ns=1000000 file_inputs=96 directory_inputs=0 bind_mounts=5 actiondfs_mounts=1 output_files=1 output_directories=1 stress_case=nested_individual_files
...
info: execute timing bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb/124: total_ns=20000000 input_fetch_ns=3000000 execution_ns=15000000 output_upload_ns=2000000 bind_mounts=1 output_files=1 output_directories=1 stress_case=generated_tree_reuse
...
grep -q "Every action uses actiondfs" "${out}"
